...
label_liczba_postow_szczegoly_obiketu = Label(ramka_szczegoly_obiektu, text = "Liczba postów: ")
...
label_liczba_postow_szczegoly_obiketu.grid(row=1, column=4)
